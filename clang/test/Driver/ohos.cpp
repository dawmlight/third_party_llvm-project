...
// CHECK: "-L{{.*[/\\]}}lib/arm-liteos/c++/"
// CHECK-NOT: "--push-state"
// CHECK-NOT: "--as-needed"
// CHECK: "-lc++"
// CHECK: "-lm"
// CHECK-NOT: "--pop-state"
// CHECK: "[[RESOURCE_DIR]]{{/|\\\\}}lib{{/|\\\\}}arm-liteos{{/|\\\\}}libclang_rt.builtins.a"
// CHECK: "-lc"
...
// CHECK-MULTILIB-ARM: "-L{{.*}}{{/|\\\\}}..{{/|\\\\}}lib{{/|\\\\}}arm-liteos{{/|\\\\}}c++/"
// CHECK-MULTILIB-ARM: "-L[[SYSROOT]]/usr/lib/arm-liteos"

// CHECK-MULTILIB-ARM-A7-SOFT: "-L{{.*}}{{/|\\\\}}..{{/|\\\\}}lib{{/|\\\\}}arm-liteos{{/|\\\\}}c++/a7_soft"
// CHECK-MULTILIB-ARM-A7-SOFT: "-L[[SYSROOT]]/usr/lib/arm-liteos/a7_soft"

// CHECK-MULTILIB-ARM-A7-SOFTFP: "-L{{.*}}{{/|\\\\}}..{{/|\\\\}}lib{{/|\\\\}}arm-liteos{{/|\\\\}}c++{{/|\\\\}}a7_softfp_neon-vfpv4"
// CHECK-MULTILIB-ARM-A7-SOFTFP: "-L[[SYSROOT]]/usr/lib/arm-liteos/a7_softfp_neon-vfpv4"

// CHECK-MULTILIB-ARM-A7-HARD: "-L{{.*}}{{/|\\\\}}..{{/|\\\\}}lib{{/|\\\\}}arm-liteos{{/|\\\\}}c++{{/|\\\\}}a7_hard_neon-vfpv4"
