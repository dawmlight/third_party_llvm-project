...
//
//===----------------------------------------------------------------------===//
// 2021.7.19 Add OHOS target support for llvm
...
public:
  ...
  bool isMusl() const {
    return getEnvironment() == Triple::Musl ||
	   ...
	   getEnvironment() == Triple::OHOSMusl ||
	   // FIXME: is LiteOS musl based?
	   isOSLiteOS();
  }
  ...
  bool isOHOS() const {
    return getEnvironment() == Triple::OHOS ||
           isOHOSMusl() ||
           isOSLiteOS();
  }

  bool isOHOSMusl() const {
    return getEnvironment() == Triple::OHOSMusl;
  }

  bool isOHOSBionic() const {
    return getEnvironment() == Triple::OHOS;
  }

  bool isOHOSVersionLT(unsigned Major) const {
    assert(isOHOS() && "Not a OHOS triple!");
  ...
  bool hasDefaultEmulatedTLS() const {
    return isAndroid() || isOSOpenBSD() || isWindowsCygwinEnvironment() || isOHOSBionic();
  }
