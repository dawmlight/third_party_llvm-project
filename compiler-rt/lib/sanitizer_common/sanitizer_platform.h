...
#if defined(__ohosmusl__)
#define SANITIZER_OHOSMUSL 1
#else
#define SANITIZER_OHOSMUSL 0
#endif
#else
...
#define SANITIZER_ANDROID_OR_OHOS (SANITIZER_ANDROID || SANITIZER_OHOS)
#define SANITIZER_BIONIC (SANITIZER_ANDROID_OR_OHOS && !SANITIZER_OHOSMUSL)
...
#if ((SANITIZER_ANDROID_OR_OHOS) && defined(__aarch64__)) || SANITIZER_FUCHSIA
